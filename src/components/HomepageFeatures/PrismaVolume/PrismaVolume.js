...
function Progresion() {
    ...
    return (
        <section className="training-sect">
                <h2 className="training-name">Онлайн тренажер. Об'єм призми</h2>
                ...
                <div className="theory-wrap-cont" id="theory-wrap-cont">
                    ...
                    <h3 className="theory-text">Формула для обрахунку об'єму призми</h3>
                    <h3 className="theory-text"><span className="theory-text-span">Об'єм призми</span> дорівнює добутку площі основи на висоту.</h3>
                    <p className="theory-formule">V = S<sub>o</sub>h</p>
                    <h3 className="theory-text">де V - об'єм призми,<br/>S<sub>o</sub> - площа основи призми,<br/>h - висота призми,</h3>
                </div>
                )}
